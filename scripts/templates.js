        ...
        <article class="menu-part">
            ...
            <section class="menu-description">
                ...
                <article class="menu-price">
                    ...
                    <button id="add-button${products.burger[i].name}" onclick="addOrder(products.burger[${i}])">
                        Add to basket
                    </button>
                </article>
            </section>
        ...
        <article class="menu-part">
            ...
            <section class="menu-description">
                ...
                <article class="menu-price">
                    ...
                    <button id="add-button${products.pizza[i].name}" onclick="addOrder(products.pizza[${i}])">
                        Add to basket
                    </button>
                </article>
            </section>
        ...
        <article class="menu-part">
            ...
            <section class="menu-description">
                ...
                <article class="menu-price">
                    ...
                    <button id="add-button${products.salad[i].name}" onclick="addOrder(products.salad[${i}])">
                        Add to basket
                    </button>
                </article>
            </section>
        ...
        <article class="basket">
            <div class="basket-infill">
                ...
                <section id="price-wrapper" class="price-wrapper" style="display: none">
                    ...
                    <button onclick="openConfirmedDialog()">
